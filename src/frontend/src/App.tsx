...
import FakeRecipientEntryPage from "./pages/FakeRecipientEntryPage";
import FakeTransactionDetailPage from "./pages/FakeTransactionDetailPage";
...
type Page =
  ...
  | "history"
  | "transaction-detail"
  | "fake-transaction-detail"
  | "fake-recipient-entry"
  | "scan"
  | "coming-soon"
  | "you"
  | "pin-setup";
...
function AppContent() {
  ...
  const [fakeRecipientDetails, setFakeRecipientDetails] = useState<{
    name: string;
    phone: string;
    upiId: string;
    amount: string;
  ...
  return (
    ...
    >
      ...
      {currentPage === "fake-recipient-entry" && (
        <FakeRecipientEntryPage
          onBack={() => {
            setCurrentPage("home");
            setActiveTab("home");
          }}
          onContinue={(details) => {
            setFakeRecipientDetails(details);
            setCurrentPage("fake-transaction-detail");
          }}
        />
      )}

      {currentPage === "fake-transaction-detail" && (
        <FakeTransactionDetailPage
          onBack={() => {
            setCurrentPage("fake-recipient-entry");
          }}
          recipientName={fakeRecipientDetails?.name}
          recipientPhone={fakeRecipientDetails?.phone}
          upiId={fakeRecipientDetails?.upiId}
          amount={fakeRecipientDetails?.amount}
        />
      )}
