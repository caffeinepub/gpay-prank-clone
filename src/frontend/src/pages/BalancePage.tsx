...
export default function BalancePage({ onBack }: BalancePageProps) {
  ...
  const handleSaveBalance = () => {
    ...
    const val = Number.isNaN(num) || num < 0 ? "0.00" : num.toFixed(2);
  ...
  const currentBalance = selectedBank
    ? selectedBank === "hdfc"
      ? hdfcBalance
      : sbiBalance
    : "0.00";
  ...
  const bankName =
    selectedBank === "hdfc" ? "HDFC Bank" : "State Bank of India";
        ...
        <div className="flex-1 flex flex-col px-4 py-6">
          ...
          <button
            ...
            style={{
              ...
              color: selectedBank ? "oklch(1 0 0)" : "oklch(0.40 0.02 250)",
        ...
        <div className="flex-1 px-4 py-6">
          ...
          >
            ...
            <p
              ...
              style={{ color: "oklch(0.80 0.08 240)" }}
            >
              Available Balance
            </p>
            ...
            <div className="relative flex items-baseline gap-2">
              ...
              <button
                type="button"
                onClick={() => {
                  setEditValue(Number.parseFloat(currentBalance).toFixed(2));
                  setEditMode(true);
                }}
