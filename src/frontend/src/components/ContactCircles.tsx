...
import { CONTACTS, Contact } from '../utils/contactData';

interface ContactCirclesProps {
  onContactClick: (contact: Contact) => void;
}

export default function ContactCircles({ onContactClick }: ContactCirclesProps) {
  return (
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  if (parent) {
                    ...
                    span.style.cssText = 'position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:1.1rem;color:white;';
