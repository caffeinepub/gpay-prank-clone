...
function RupeeCircleIcon({ size = 22, color = 'currentColor' }: { size?: number; color?: string }) {
  return (
    <svg
      width={size}
      height={size}
        ...
        {tabs.map(({ id, label, icon }) => {
          ...
          return (
            ...
            >
              ...
              <div
                style={{
                  background: isActive && id === 'home' ? 'oklch(0.35 0.12 175)' : 'transparent',
                  borderRadius: 50,
              ...
              >
                {icon === 'home' && (
                  <Home
                    size={22}
                    style={{
                      color: isActive ? 'oklch(0.97 0.005 250)' : 'oklch(0.60 0.02 250)',
